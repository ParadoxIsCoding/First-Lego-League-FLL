...
#drop off octopus
wait(1000)
LG.run_time(-100,700,Stop.BRAKE,wait=False)
...
RG.run_angle(400,-1200,Stop.HOLD,wait=False)
robot.turn(40,Stop.HOLD)
robot.straight(122,Stop.HOLD)
robot.turn(-40,Stop.HOLD)
 
#anglar fish and sample
robot.straight(150,Stop.HOLD)
RG.run_angle(400,600,Stop.HOLD)
wait(2000)
...
RG.run_time(-800,2300,Stop.HOLD)
